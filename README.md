...
2. [Projeto 2](github.com/NathaliaJnascimento/checklist-app): Checklist é um aplicativo desenvolvido para facilitar a organização de compras, permitindo criar listas, marcar produtos, ajustar quantidades, calcular o valor total da compra por meio de uma calculadora integrada e salvar listas para uso futuro. Seu objetivo é tornar as compras mais práticas e organizadas.
